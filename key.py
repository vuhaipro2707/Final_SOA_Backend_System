...
PUBLIC_KEY_PATH_API = "ApiGateway/app/public_key.pem"
PUBLIC_KEY_PATH_WS = "websocket-service/src/main/resources/keys/public_key.pem"
...
create_directory(PUBLIC_KEY_PATH_API)
with open(PUBLIC_KEY_PATH_API, "wb") as f:
    f.write(public_key_pem)
    print(f"✅ Đã tạo tệp Public Key tại: {PUBLIC_KEY_PATH_API}")

create_directory(PUBLIC_KEY_PATH_WS)
with open(PUBLIC_KEY_PATH_WS, "wb") as f:
    f.write(public_key_pem)
    print(f"✅ Đã tạo tệp Public Key tại: {PUBLIC_KEY_PATH_WS}")
